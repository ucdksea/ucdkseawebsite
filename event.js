...
function replacePlaceholders(text) {
  const replacements = {
    ...
    '<img-placeholder_resume_2024fall/>': '<br><span style="display: inline-block; width: auto; height: auto; box-shadow: 0 0 10px rgba(0, 0, 0, 0.5);"><img src="images/event/2024_fall/resume/resume_poster.png" alt="Additional Image" style="width: 100%; height: auto;" /></span>',
    '<img-placeholder_dodream_2/>': '<br><span style="display: inline-block; width: auto; height: auto; box-shadow: 0 0 10px rgba(0, 0, 0, 0.5);"><img src="images/event/2024_fall/job/job_poster.PNG" alt="Additional Image" style="width: 100%; height: auto;" /></span>',
    '<img-placeholder_왔다감_2024fall/>': '<br><span style="display: inline-block; width: auto; height: auto; box-shadow: 0 0 10px rgba(0, 0, 0, 0.5);"><img src="images/event/2024_fall/came/왔다감_poster.png" alt="Additional Image" style="width: 100%; height: auto;" /></span>',
